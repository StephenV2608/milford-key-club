...
export default function OfficerCard({ name, role, funFact, photoUrl }) {
  return (
    <div className="bg-card rounded-xl border border-border p-6 text-center hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
