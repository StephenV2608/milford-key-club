        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8">
          <div>
            <div className="flex items-center gap-2.5 mb-4">
              {settings.logo_url ? (
                <img src={settings.logo_url} alt={settings.site_name} className="h-10 w-10 rounded-lg object-contain bg-white/10 p-0.5" />
              ) : (
          ...
          <div>
            ...
            <div className="space-y-2 text-sm opacity-70">
              ...
              <div className="flex gap-4 pt-3">
                <a href={settings.instagram_url || '#'} className="hover:opacity-100 transition-opacity" aria-label="Instagram">
                ...
                {settings.show_twitter !== false && (
                  <a href={settings.twitter_url || '#'} className="hover:opacity-100 transition-opacity" aria-label="Twitter">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                  </a>
                )}
                {settings.show_facebook !== false && settings.facebook_url && (
                  <a href={settings.facebook_url} className="hover:opacity-100 transition-opacity" aria-label="Facebook">
