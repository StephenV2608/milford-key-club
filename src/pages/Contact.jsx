          ...
          <div className="grid md:grid-cols-5 gap-10 md:gap-16">
            <div className="md:col-span-2 space-y-6">
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        {settings.meeting_location || 'Milford High School\nRoom 204'}
                      </p>
                    </div>
                  </div>
                  )}
              ...
              <div>
                ...
                <div className="flex gap-3">
                  <a href={settings.instagram_url || '#'} className="w-10 h-10 rounded-lg bg-muted flex items-center justify-center hover:bg-accent transition-colors" aria-label="Instagram">
                  ...
                  <a href={settings.twitter_url || '#'} className="w-10 h-10 rounded-lg bg-muted flex items-center justify-center hover:bg-accent transition-colors" aria-label="Twitter/X">
            ...
            <div className="md:col-span-3">
              <form onSubmit={handleSubmit} className="bg-card rounded-xl border border-border p-6 md:p-8 space-y-5">
                <div className="space-y-2">
                  ...
                  <Input id="name" placeholder="Your name" value={formData.name} onChange={(e) => setFormData(p => ({ ...p, name: e.target.value }))} required />
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea id="message" placeholder="What's on your mind?" rows={5} value={formData.message} onChange={(e) => setFormData(p => ({ ...p, message: e.target.value }))} required />
                </div>
